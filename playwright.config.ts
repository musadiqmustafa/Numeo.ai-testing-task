...
const config: PlaywrightTestConfig = {
    ...
    reporter: process.env.REPORT_FORMAT === 'list' ? 'list' : 'html',
    ...
    use: {
        ...
        baseURL: process.env.BASE_URL || 'http://ovcharski.com/shop/',
        ...
        /* Record video */
        video: process.env.VIDEO_ON_FAILURE === 'true' ? 'on' : 'retain-on-failure',
